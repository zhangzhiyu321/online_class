...
-- student002 与其他老师的聊天关系
(2, 8, NULL, 0, 1, 0, 0, '2024-01-20 16:00:00'),
(3, 8, NULL, 1, 0, 0, 0, '2024-01-20 15:30:00'),
(5, 8, NULL, 0, 0, 0, 0, '2024-01-19 18:00:00'),
(6, 8, NULL, 0, 2, 0, 0, '2024-01-20 17:00:00');
...
-- student002 与 teacher001 (张老师) 的聊天记录
(7, 2, 8, 1, '小红你好，我是张老师，听说你想咨询数学课程？', 0, NULL, '2024-01-20 15:30:00'),
(7, 8, 2, 1, '张老师好，我想了解一下初中数学的教学方式', 1, '2024-01-20 15:35:00', '2024-01-20 15:35:00'),
(7, 2, 8, 1, '好的，我主要采用启发式教学，注重培养学生的逻辑思维能力', 0, NULL, '2024-01-20 15:40:00'),
(7, 8, 2, 1, '听起来很不错，我想先试听一节课可以吗？', 0, NULL, '2024-01-20 16:00:00'),
-- student002 与 teacher002 (李老师) 的聊天记录
(8, 8, 3, 1, '李老师您好，我想咨询一下高中物理课程', 1, '2024-01-20 15:00:00', '2024-01-20 15:00:00'),
(8, 3, 8, 1, '你好小红，很高兴为你解答。你现在是几年级？', 0, NULL, '2024-01-20 15:05:00'),
(8, 8, 3, 1, '我现在是初二，想提前学习一些物理知识', 0, NULL, '2024-01-20 15:10:00'),
(8, 3, 8, 1, '很好，提前学习有助于打好基础。我可以为你制定一个学习计划', 0, NULL, '2024-01-20 15:30:00'),
-- student002 与 teacher004 (刘老师) 的聊天记录
(9, 5, 8, 1, '小红你好，我是刘老师，化学教学经验丰富', 1, '2024-01-19 17:30:00', '2024-01-19 17:30:00'),
(9, 8, 5, 1, '刘老师好，我想了解一下化学课程', 1, '2024-01-19 17:35:00', '2024-01-19 17:35:00'),
(9, 5, 8, 1, '好的，我主要教授高中化学，对高考化学有深入研究', 1, '2024-01-19 17:40:00', '2024-01-19 17:40:00'),
(9, 8, 5, 1, '谢谢老师，我会考虑一下', 1, '2024-01-19 18:00:00', '2024-01-19 18:00:00'),
-- student002 与 teacher005 (陈老师) 的聊天记录
(10, 8, 6, 1, '陈老师您好，我想咨询语文课程，特别是作文方面', 0, NULL, '2024-01-20 16:30:00'),
(10, 6, 8, 1, '你好小红，我在作文指导方面很有经验', 0, NULL, '2024-01-20 16:35:00'),
(10, 8, 6, 1, '太好了，我的作文一直写不好，希望能得到您的指导', 0, NULL, '2024-01-20 16:40:00'),
(10, 6, 8, 1, '没问题，我会从基础开始，逐步提升你的写作水平', 0, NULL, '2024-01-20 16:45:00'),
(10, 8, 6, 1, '谢谢老师，期待您的课程', 0, NULL, '2024-01-20 17:00:00');
